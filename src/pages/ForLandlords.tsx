...
const comparisonData = [
  { feature: "Monthly Plan", runp8: "$9.99/mo", competitor: "$16.58/mo" },
  { feature: "Annual Plan", runp8: "$99/yr", competitor: "$199/yr" },
  { feature: "Commission Fees", runp8: "0%", competitor: "0–10%" },
  { feature: "Tenant Screening Cost", runp8: "Free (we pay)", competitor: "$44.99/tenant" },
  { feature: "Direct Messaging", runp8: "Included", competitor: "Included" },
  { feature: "Fresno County Focus", runp8: "Specialized", competitor: "Generic" },
];
...
const faqs = [
  {
    q: "How is runp8 different from FurnishedFinder?",
      ...
      <section className="mx-auto max-w-6xl px-4 py-20">
        <div className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-muted-foreground">
            We built runp8 for landlords who are tired of overpaying platforms that underdeliver.
          </p>
        </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border bg-primary/5">
                ...
                <th className="px-5 py-4 text-center font-[var(--font-heading)] font-bold text-primary text-lg">runp8</th>
                <th className="px-5 py-4 text-center font-semibold text-muted-foreground">Others</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-border">
              {comparisonData.map(({ feature, runp8: ours, competitor }) => (
      ...
      <footer className="border-t border-border bg-card">
        <div className="mx-auto max-w-6xl px-4 py-10">
          ...
          <p className="mt-6 text-center text-xs text-muted-foreground">
            © {new Date().getFullYear()} runp8. All rights reserved. Fresno County, California.
          </p>
        </div>
      </footer>
    </div>
