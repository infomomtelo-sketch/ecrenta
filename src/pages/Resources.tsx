...
const strategies = [
  ...
  },
  {
    ...
    description: "Publish 2-4 blog posts per month targeting local search queries. Position runp8 as THE resource for Fresno furnished rentals.",
  ...
  },
  {
    ...
    description: "Cross-post listings on Craigslist, Facebook Marketplace, Zillow, and even FurnishedFinder — but funnel repeat tenants back to runp8 for free screening.",
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-4 py-8 space-y-12">
        ...
        <section className="rounded-xl bg-primary/5 border border-primary/20 p-6 text-center space-y-3">
          ...
          <p className="text-xs text-muted-foreground">Available as a free PDF for runp8 landlords.</p>
        </section>
