        ...
        <div className="mx-auto mt-20 max-w-2xl">
          ...
          <div className="space-y-4">
            {[
              ...
              { q: "What's in the Premium Service tier?", a: "Premium adds our P8 AI Assistant (instant answers and tenant message triage), a dedicated account manager, quarterly property inspections with photo reports, priority vendor scheduling for faster maintenance, tax-ready quarterly reports, and custom branding on tenant communications." },
