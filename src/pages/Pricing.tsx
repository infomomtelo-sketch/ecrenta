        ...
        <div className="mx-auto mt-20 max-w-2xl">
          ...
          <div className="space-y-4">
            {[
              ...
              { q: "Why is EC Rental Property Management LLC cheaper than competitors?", a: "We keep costs low by focusing on one region and building lean. No commissions, no hidden fees — just a simple subscription for landlords." },
            ].map((faq) => (
