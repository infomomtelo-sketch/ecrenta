...
export default function RentalForms() {
  ...
  const handleExportPDF = useCallback(() => {
    ...
    html += `<div class="footer">Generated by EC Rental Property Management LLC · myrental.space</div>`;
    html += `</body></html>`;
  ...
  if (view === "library") {
    return (
      <div className="p-4 md:p-6 max-w-6xl mx-auto">
        <Helmet><title>Rental Forms | myrental</title></Helmet>
  ...
  if (view === "fill" && selectedTemplate) {
    return (
      <div className="p-4 md:p-6 max-w-2xl mx-auto">
        <Helmet><title>{selectedTemplate.name} | myrental</title></Helmet>
  ...
  return (
    <div className="p-4 md:p-6 max-w-5xl mx-auto">
      <Helmet><title>Form Builder | myrental</title></Helmet>
