...
const socialLinks = [
  { name: "Instagram", url: "https://instagram.com/runp8", icon: "📸", color: "from-pink-500 to-purple-500" },
  { name: "Twitter / X", url: "https://x.com/runp8", icon: "𝕏", color: "from-sky-400 to-blue-500" },
  { name: "Facebook", url: "https://facebook.com/runp8", icon: "📘", color: "from-blue-500 to-blue-700" },
  { name: "YouTube", url: "https://youtube.com/@runp8", icon: "▶️", color: "from-red-500 to-red-700" },
  { name: "TikTok", url: "https://tiktok.com/@runp8", icon: "🎵", color: "from-gray-700 to-gray-900" },
];
    ...
    <div className="flex min-h-screen flex-col items-center bg-background px-4 py-12">
      ...
      <div className="flex w-full max-w-sm flex-col gap-3">
        {socialLinks.map((link) => (
          ...
          >
            <div className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br ${link.color} text-lg`}>
              {link.icon}
            </div>
