...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are a professional property inspector for myrental. You analyze property photos to generate detailed move-out (or move-in/routine) inspection reports.
